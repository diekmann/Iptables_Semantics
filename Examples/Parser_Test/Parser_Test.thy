...
[(''DOS~Pro-t_ect'',
   [Rule (MatchAnd (Match (Prot (Proto TCP))) (Match (Dst_Ports [(0x16, 0x16)]))) action.Accept,
    ...
    Rule (MatchAnd (Match (Prot (Proto ICMP))) (Match (Extra ''-m icmp --icmp-type 3/4''))) action.Accept,
    Rule (MatchAnd (Match (Prot (Proto ICMP)))
           (Match (Extra [CHR ''-'', CHR ''m'', CHR '' '', CHR ''c'', CHR ''o'', CHR ''m'', CHR ''m'', CHR ''e'',
                          CHR ''n'', CHR ''t'', CHR '' '', CHR ''-'', CHR ''-'', CHR ''c'', CHR ''o'', CHR ''m'',
                          CHR ''m'', CHR ''e'', CHR ''n'', CHR ''t'', CHR '' '', Char Nibble2 Nibble2, CHR ''!'',
                          Char Nibble2 Nibble2])))
     action.Accept,
    Rule (MatchAnd (Match (Prot (Proto ICMP)))
           (Match (Extra [CHR ''-'', CHR ''m'', CHR '' '', CHR ''c'', CHR ''o'', CHR ''m'', CHR ''m'', CHR ''e'',
                          CHR ''n'', CHR ''t'', CHR '' '', CHR ''-'', CHR ''-'', CHR ''c'', CHR ''o'', CHR ''m'',
                          CHR ''m'', CHR ''e'', CHR ''n'', CHR ''t'', CHR '' '', Char Nibble2 Nibble2, CHR ''h'',
                          CHR ''a'', CHR ''s'', CHR '' '', CHR ''s'', CHR ''p'', CHR ''a'', CHR ''c'', CHR ''e'',
                          Char Nibble2 Nibble2])))
     action.Accept,
    Rule (Match (Prot (Proto ICMP))) action.Accept,
    Rule (MatchAnd (Match (Extra ''!'')) (Match (Prot (Proto ICMP)))) Empty,
    Rule (MatchAnd (Match (Extra ''!''))
           (MatchAnd (Match (Prot (Proto TCP))) (MatchNot (Match (Src (Ip4AddrNetmask (131, 159, 0, 0) 16))))))
     Empty]),
  (''FORWARD'',
   [Rule (Match (Extra [CHR ''-'', CHR ''-'', CHR ''l'', CHR ''o'', CHR ''g'', CHR ''-'', CHR ''p'', CHR ''r'',
                        CHR ''e'', CHR ''f'', CHR ''i'', CHR ''x'', CHR '' '', Char Nibble2 Nibble2, CHR ''!'',
                        CHR ''#'', CHR ''*'', CHR ''~'', CHR ''%'', CHR ''&'', CHR ''/'', CHR ''('', CHR '')'',
                        CHR ''='', CHR ''?'', Char Nibble2 Nibble2, CHR '' '', CHR ''-'', CHR ''-'', CHR ''l'',
                        CHR ''o'', CHR ''g'', CHR ''-'', CHR ''l'', CHR ''e'', CHR ''v'', CHR ''e'', CHR ''l'',
                        CHR '' '', CHR ''6'']))
     Log,
    Rule (Match (Src (Ip4AddrNetmask (127, 0, 0, 0) 8))) action.Drop,
    Rule (MatchAnd (Match (IIface (Iface ''wlan0'')))
           (MatchAnd (Match (Prot (Proto TCP)))
             (MatchAnd (Match (Extra ''-m tcp ! --tcp-flags FIN,SYN,RST,ACK SYN'')) (Match (CT_State {CT_New})))))
     action.Drop,
    ...
    Rule (MatchAnd (Match (Prot (Proto TCP))) (Match (Src_Ports [(0x50, 0x50), (0x1BB, 0x1BB)]))) action.Drop,
    Rule (MatchAnd (Match (Prot (Proto TCP))) (Match (Dst_Ports [(0x50, 0x50), (0x1BB, 0x1BB)]))) action.Drop,
