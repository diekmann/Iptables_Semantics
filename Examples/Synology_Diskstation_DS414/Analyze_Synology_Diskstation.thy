...
value "to_simple_firewall (upper_closure (unfold_ruleset_INUPUT example_ruleset))"
value "to_simple_firewall (lower_closure (unfold_ruleset_INUPUT example_ruleset))"
