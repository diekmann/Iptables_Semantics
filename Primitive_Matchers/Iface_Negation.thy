...
(* Old and file; not maintained. TODO: finish this thy to get Ifaces with negation support*)

section{*Network Interfaces with Negation Support*}

text_raw{*I don't think I can find a good way to support negated interfaces.
