...
readIpAssmt filename = do
    ...
    case parseIpAssmt_ipv6 filename src of
        ...
        readArgsLabeled (CommandLineArgsLabeled (Helpful verbose)
            ...
            assmt <- case ipassmtFilePath of
                        ...
                        Nothing -> do
                            ...
                            return Isabelle.ipassmt_generic_ipv6
...
main = do 
    ...
    case parseIptablesSave_ipv6 srcname src of
        Left err -> do
        ...
        Right res -> do
            ...
            let (warnings, spoofResult) = certifySpoofingProtection_ipv6 ipassmt unfolded
            ...
            mapM_ (\(s,d) -> 
                     ...
                     >> putStrLn (showServiceMatrix (Analysis.accessMatrix_ipv6 ipassmt unfolded s d))) smOptions
