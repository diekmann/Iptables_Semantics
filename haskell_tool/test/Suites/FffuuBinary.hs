...
tests = testGroup "fffuu compiled binary output" $
  ...
  , execFffuu "stressing the parser" ["--verbose", "../thy/Examples/Parser_Test/data/iptables-save"] "test/Suites/GoldenFiles/parser_test"
  ...
  , execFffuu "SQRL spoofing raw" ["--verbose", "--table", "raw", "--chain", "PREROUTING", "--ipassmt", "ipassmt_sqrl", "../thy/Examples/SQRL_Shorewall/2015_aug_iptables-save-spoofing-protection"] "test/Suites/GoldenFiles/sqrl_2015_aug_iptables-save-spoofing-protection"
  , execFffuu "synology example from README" ["--verbose", "--chain", "INPUT", "--service_matrix_dport", "22", "--service_matrix_dport", "8080", "--service_matrix_dport", "80", "../thy/Examples/Synology_Diskstation_DS414/iptables-save_jun_2015_cleanup"] "test/Suites/GoldenFiles/synology_iptables-save_jun_2015_cleanup"
  ]
