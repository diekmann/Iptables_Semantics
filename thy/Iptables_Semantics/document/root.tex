...
\begin{abstract}  
  ...
  The tool does not require any input ---except the \texttt{iptables-save} dump of the analyzed firewall--- and presents the user with interesting results about her ruleset. 
